...
// source: phar://C:\Users\magic\Desktop\docker-stacks\touche_pas_au_klaxon\vendor\phpstan\phpstan\phpstan.phar/conf/config.level6.neon
...
class Container_e751373193 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_e751373193 $container)
			{
	...
	public function createServiceContainer(): Container_e751373193
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'LINES' => '17',
				'PHPRC' => 'C:\Users\magic\AppData\Local\Temp\8B0D.tmp',
				...
				'WINDIR' => 'C:\WINDOWS',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\magic\AppData\Local\Temp\8B0D.tmp|0|*|*|C:\wamp64\bin\php\php8.3.6\php.ini|3.3.2',
