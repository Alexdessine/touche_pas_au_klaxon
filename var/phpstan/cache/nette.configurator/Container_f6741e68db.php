...
class Container_f6741e68db extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_f6741e68db $container)
			{
	...
	public function createServiceContainer(): Container_f6741e68db
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'LINES' => '17',
				'PHPRC' => 'C:\Users\magic\AppData\Local\Temp\4D17.tmp',
				...
				'WINDIR' => 'C:\WINDOWS',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\magic\AppData\Local\Temp\4D17.tmp|0|*|*|C:\wamp64\bin\php\php8.3.6\php.ini|3.3.2',
